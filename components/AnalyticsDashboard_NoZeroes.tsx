...
const AnalyticsDashboard: React.FC<AnalyticsDashboardProps> = ({
  ...
  // Transform API data to chart format (excluding zero values)
  const transformApiDataToChart = (
    ...
    // Filter out labels and data points where count is 0
  ...
  const chartWidth = Math.max(
    screenWidth - 32,
    analyticsData?.labels.length ? analyticsData.labels.length * 60 : 300
  );
